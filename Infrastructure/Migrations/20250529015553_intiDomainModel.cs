...
{
    /// <inheritdoc />
    public partial class intiDomainModel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Progresses_Students_StudentId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QRCodeValidations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QRCodeValidations_Enrollments_EnrollmentId",
                        column: x => x.EnrollmentId,
                        principalTable: "Enrollments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_QRCodeValidations_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "ProgressCompletedSessions",
                columns: table => new
                {
                    CompletedSessionsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProgressId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProgressCompletedSessions", x => new { x.CompletedSessionsId, x.ProgressId });
                    table.ForeignKey(
                        name: "FK_ProgressCompletedSessions_Progresses_ProgressId",
                        column: x => x.ProgressId,
                        principalTable: "Progresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProgressCompletedSessions_Sessions_CompletedSessionsId",
                        column: x => x.CompletedSessionsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgressCompletedSessions_ProgressId",
                table: "ProgressCompletedSessions",
                column: "ProgressId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Progresses_StudentId1",
                table: "Progresses",
                column: "StudentId1");

            migrationBuilder.CreateIndex(
                name: "IX_QRCodeValidations_EnrollmentId",
                table: "QRCodeValidations",
                column: "EnrollmentId");

            migrationBuilder.CreateIndex(
                name: "IX_QRCodeValidations_StudentId",
                table: "QRCodeValidations",
                column: "StudentId");
